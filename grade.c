...
void add_node1(char *identity, char *name, char *sirname, float avg_grade, binary_tree* bt);
void add_node2(char *identity, char *name, char *sirname, float avg_grade, binary_tree* bt);
void read_db_to_tree1(binary_tree *);
...
void add_node1(char *identity, char *name, char *sirname,
    ...
    else add1(leaf, bt->root);
}

//Add Node to Binary Tree (Client Side)
void add_node2(char *identity, char *name, char *sirname,
    float avg_grade, binary_tree* bt)
    {
...
void read_db_to_tree1(binary_tree* tree){
    FILE *fh;
    fh = fopen("student_database.txt","r");
    ...
    while(fgets(buffer, line_size, fh)!=NULL){
        ...
        add_node1(identity, name, sirname, avg_grade, tree);
    }
}

//Read text database to in-memory binary tree
void read_db_to_tree2(binary_tree* tree){
    FILE *fh;
    fh = fopen("student_database.txt","r");
    ...
    while(fgets(buffer, line_size, fh)!=NULL){
        ...
        sirname = strtok(NULL," ");
        avg_grade = atof(strtok(NULL, " "));
        add_node2(identity, name, sirname, avg_grade, tree);
    }
}
